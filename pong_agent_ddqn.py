...
EVAL_SAVE_FORMAT = "./checkpoint/eval_net-episode-{}"
TARG_SAVE_FORMAT = "./checkpoint/targ_net-episode-{}"
...
class PongAgent(Agent, ReplayMemory):
    ...
    def save_model(self):
        torch.save(self.eval_net.state_dict(), EVAL_SAVE_FORMAT.format(self.iteration_count))
        torch.save(self.targ_net.state_dict(), TARG_SAVE_FORMAT.format(self.iteration_count))
